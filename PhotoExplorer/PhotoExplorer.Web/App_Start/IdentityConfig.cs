...
namespace PhotoExplorer.Web
{
    ...
    public class ApplicationUserManager : UserManager<UserModel>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<UserModel>(context.Get<PhotoExplorerDbContext>()));
            ...
            manager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProvider<UserModel>
            {
                MessageFormat = "Your security code is {0}"
            });
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<UserModel>
            {
